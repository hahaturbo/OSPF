        ...
        (this.getPosition = function (a) {
          ...
          return (
            "Top_Left" == a
              ...
              : "Bottom_Right" == a && (b = { x: c.right, y: c.bottom }),
            b
          );
        });
    }
      ...
      (this.initialize = function () {
        ...
        (this.selectedHandler = function (b) {
          d.prototype.selectedHandler.apply(this, arguments),
            (this.selectedSize = { width: this.width, height: this.height }),
        ...
        (this.getTextPostion = function (a, b, c) {
          ...
          return (
            null == a || "Bottom_Center" == a
              ...
              : "Top_Right" == a
              ? (d = { x: this.width / 2, y: -this.height / 2 - c / 2 })
              : "Top_Left" == a
              ? (d = { x: -this.width / 2 - b, y: -this.height / 2 - c / 2 })
              : "Bottom_Right" == a
              ? (d = { x: this.width / 2, y: this.height / 2 + c })
              : "Bottom_Left" == a
              ? (d = { x: -this.width / 2 - b, y: this.height / 2 + c })
              : "Middle_Center" == a
              ? (d = { x: -this.width / 2 + (this.width - b) / 2, y: c / 2 })
              : "Middle_Right" == a
              ? (d = { x: this.width / 2, y: c / 2 })
              : "Middle_Left" == a &&
                (d = { x: -this.width / 2 - b, y: c / 2 }),
      ...
      (this.initialize = function (b, c, d) {
        ...
        (this.getEndPosition = function () {
          ...
          return (
            ...
            null == a && (a = { x: this.nodeZ.cx, y: this.nodeZ.cy }),
            a
          );
        }),
          ...
          return (
            "horizontal" == this.direction
              ? (this.nodeA.cx > this.nodeZ.cx && (i = -i),
                d.push({ x: b.x, y: b.y + h }),
                d.push({ x: b.x + i, y: b.y + h }),
                d.push({ x: c.x - i, y: c.y + h }),
                d.push({ x: c.x, y: c.y + h }))
              : (this.nodeA.cy > this.nodeZ.cy && (i = -i),
                d.push({ x: b.x + h, y: b.y }),
                d.push({ x: b.x + h, y: b.y + i }),
                d.push({ x: c.x + h, y: c.y - i }),
                d.push({ x: c.x + h, y: c.y })),
            d
          );
        });
    }
    ...
    function o(a, b, c, d, e, f) {
      ...
      if ("bottom" == g)
        for (var i = a - (c / 2) * d + d / 2, j = 0; c >= j; j++)
          h.push({ x: i + j * d, y: b + e });
      else if ("top" == g)
        for (var i = a - (c / 2) * d + d / 2, j = 0; c >= j; j++)
          h.push({ x: i + j * d, y: b - e });
      else if ("right" == g)
        for (var i = b - (c / 2) * d + d / 2, j = 0; c >= j; j++)
          h.push({ x: a + e, y: i + j * d });
      else if ("left" == g)
        for (var i = b - (c / 2) * d + d / 2, j = 0; c >= j; j++)
          h.push({ x: a - e, y: i + j * d });
      return h;
    ...
    function h(b, c) {
      ...
      function e(c, e) {
        ...
        (b.visible = !1),
          e.add(h),
          e.add(j),
          a.Animate.gravity(h, { context: e, dx: 0.3 })
            .run()
            .onStop(function () {
              e.remove(h), e.remove(j), i.stop();
            }),
          a.Animate.gravity(j, { context: e, dx: -0.2 }).run();
      }
      function f() {
